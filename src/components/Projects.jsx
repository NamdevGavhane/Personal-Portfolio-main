...
const Projects = () => {
  ...
  return (
      ...
      <div className="WRAPPER mt-10" data-aos="fade-down">
        ...
        >
          <Project_prop
            ...
            img={Portfolio}
            // link="https://personal-portfolio-main-black.vercel.app/"
            github_link="https://github.com/kiranwarkad1/Personal-Portfolio"
            react={
    ...
    <Project_prop
  title="Chat App"
  para="A real-time one-on-one chat application built with the MERN stack and Socket.io for seamless communication."
  img={Jobby_App}
  link="https://chat-application-beige-rho.vercel.app/"
  github_link="https://github.com/kiranwarkad1/Chat-Application.git/"
  react={
    <Tooltip title="React" arrow>
      <IconButton>
        <SiReact className="dark:text-slate-200 text-black" />
...
/>
         ...
         <Project_prop
  title="Locatesy"
  para="A full-stack web application for seamless property listing, booking, and user management."
  img={Space_Blog}
  github_link="https://github.com/kiranwarkad1/-Locatesy-Online-Property-Management-System.git"
  react={
    <Tooltip title="React" arrow>
      <IconButton>
        <SiReact className="dark:text-slate-200 text-black" />
